...
# Redis
# uniform random
#/users/kanwu/memtier_benchmark/memtier_benchmark -p $PORT --run-count=1 -c 50 --threads=4 --hide-histogram -n 10000 --ratio=0:1 --key-pattern=R:R --key-maximum=$KEYSPACE
# sequential
...
#memcached
# uniform random
/users/kanwu/memtier_benchmark/memtier_benchmark -P memcache_text -p $PORT --run-count=1 -c 50 --threads=8 --hide-histogram -n 5000 --ratio=0:1 --key-pattern=R:R --key-maximum=$KEYSPACE --key-prefix=""
